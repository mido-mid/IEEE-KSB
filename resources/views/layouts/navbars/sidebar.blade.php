            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                        ...
                        <img alt="Image placeholder" src="{{ asset('argon') }}/logo.png">
                        </span>
                    </div>
                </a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                        ...
                        <span class="nav-link-text" style="color: #f4645f;">{{ __('Owner') }}</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('volunteers.index') }}">
                        <i class="ni ni-planet text-blue"></i> {{ __('Volunteers') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('articles.index') }}">
                        <i class="fas fa-newspaper text-red"></i> {{ __('Articles') }}
                    </a>
                </li>
                <li class="nav-item">
