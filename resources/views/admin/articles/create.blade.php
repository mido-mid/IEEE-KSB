                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Articles Management') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('articles.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description" rows="5" id="input-description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('description') }}"  required>
                                        {{ old('description') }}
                                    </textarea>
                                ...
                                <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="date" id="input-date" class="form-control form-control-alternative{{ $errors->has('date') ? ' is-invalid' : '' }}" placeholder="{{ __('date') }}" value="{{ old('date') }}" required>
